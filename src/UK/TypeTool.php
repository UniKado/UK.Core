<?php
/**
 * In this file the static class '\UK\TypeTool' is defined.
 *
...
abstract class TypeTool
{
    ...
    * @return string Returns the name of the type (see \UK\Type::PHP_* constants) or boolean FALSE if the value has not native type
    */
    ...
    * @param  string $newType Native PHP type as target type. (See \UK\Type::PHP_* constants)
    * @return mixed
    * @throws \UK\ArgumentError
    */
